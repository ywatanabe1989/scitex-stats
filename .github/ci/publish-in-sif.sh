...
# (project=scitex-stats, owner=ywatanabe1989, repo=scitex-stats,
...
TMPDIR="/tmp/publish-scitex_stats-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-stats dist/* uploaded to PyPI via manual OIDC trusted publishing"
