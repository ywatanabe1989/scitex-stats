#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# File: /home/ywatanabe/proj/scitex-stats/tests/examples/test_01_basic_ttest.py

"""Smoke test for examples/01_basic_ttest.py.
...
EXAMPLE = Path(__file__).resolve().parents[2] / "examples" / "01_basic_ttest.py"
